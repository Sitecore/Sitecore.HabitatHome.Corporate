...
namespace Sitecore.HabitatHome.Feature.Components.Controllers
{
    public class ComponentController : Controller
    {
        ...
        public ViewResult Breadcrumb()
        {
            ...
            if (MainUtil.GetBool(Context.Items[Sitecore.Demo.Shared.Foundation.SitecoreExtensions.Constants.WildCardItemResolvedKey], false))
                items = ((Item) Context.Items[Sitecore.Demo.Shared.Foundation.SitecoreExtensions.Constants.WildCardItemResolvedOldContextItemKey]).Axes.GetAncestors();
